        ...
        <View className="relative shadow-lg bg-white">
          ...
          <View className="absolute flex-row inset-x-0 top-5 justify-between px-6">
            <TouchableOpacity
              ...
              className="w-10 h-10 rounded-md bg-white items-center justify-center"
            >
              <FontAwesome5 name="chevron-left" size={24} color="#06B2BE" />
            </TouchableOpacity>
            <TouchableOpacity className="w-10 h-10 rounded-md bg-[#06B2BE] items-center justify-center">
          ...
          <View className="absolute flex-row inset-x-0 bottom-5 justify-between px-6">
            ...
            {data?.open_now_text && (
              <View className="items-center justify-center px-2 py-1 rounded-md bg-teal-100">
